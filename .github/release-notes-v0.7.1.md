# SoloPDF 0.7.1 — 链接能点了，还有手绘、撤销、分屏、翻译

（0.7 系列的第一个公开版本；v0.7.0 只打了 tag、没有发布。）
...
| 系统 | 文件 |
| --- | --- |
| macOS（Apple Silicon 与 Intel 通用） | `SoloPDF_0.7.1_universal.dmg` — 已公证，下载后直接打开 |
| Windows x64 | `SoloPDF_0.7.1_x64-setup.exe`（或 `_x64_en-US.msi`） |
| Windows ARM64 | `SoloPDF_0.7.1_arm64-setup.exe`（或 `_arm64_en-US.msi`） |
| Linux x64 | `SoloPDF_0.7.1_amd64.deb` / `SoloPDF_0.7.1_amd64.AppImage` |
| Linux ARM64 | `SoloPDF_0.7.1_arm64.deb` / `SoloPDF_0.7.1_aarch64.AppImage` |
...
完整改动见 [CHANGELOG](https://github.com/zhitongblog/solopdf/blob/v0.7.1/CHANGELOG.md)。
